...
database attached tomorrow is a different one. Risk is a function of the policy,
the assets, the consequences and the date — **and the policy is the input that does
not move.**
