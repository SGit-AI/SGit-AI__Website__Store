...
| [The design brief](/admin/design-brief/) | What a design session needs to mock up the rest of this store without access to the repository: the constraints with the hard rules named, the real tokens read from the stylesheet, eighteen components and nine screens. The markdown twin is the pasteable form. |
