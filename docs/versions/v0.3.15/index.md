# v0.3.15 — the rest of the next store: the comparison, the doors, the ledger and the person

Four more pages at /next/, each rendered from the file the current store is
