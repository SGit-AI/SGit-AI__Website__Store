# v0.3.4 — a product page, prototyped where it cannot do any harm

A level page on this store argues about what a policy is. A product page shows the thing. Those are different documents and this store has only ever written the first — which is the diagnosis, in the words it arrived in: we go there, we don't know what we're buying.
