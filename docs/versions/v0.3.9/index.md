# v0.3.9 — the moves, on the board

Ten units under a new workstream, take-the-moves. The critique produced six moves and the panel produced six proposals, and until now every one of them existed only in prose on two pages — which is how a borrowed idea gets adopted and then quietly reverted.
