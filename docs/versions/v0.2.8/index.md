# v0.2.8 — the comparison table, free column first

The store explained each level on its own page, which meant nobody ever saw the four side by side — and every sentence worth reading about them is a DIFFERENCE, which is only legible next to the thing it differs from. /compare/ is fourteen rows in four groups: what you get, whose work it is, what you may do with it, and when it arrives.
